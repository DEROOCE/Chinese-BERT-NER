...
class DataPreprocess():
    ...
    def train_test_split(self):
        ...
        with open("D:/03_code/chinese_ner/NER2/data/train_data.json", "w", encoding="utf-8") as f:
            f.write(
                '\n'.join(json.dumps(i, ensure_ascii=False) for i in train_data) 
            )
            
        with open("D:/03_code/chinese_ner/NER2/data/test_data.json", "w", encoding="utf-8") as f:
            f.write(
